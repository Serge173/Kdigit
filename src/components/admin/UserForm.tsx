...
export function UserForm({ initial, userId }: UserFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="bg-white rounded-2xl border border-border p-6 space-y-5 max-w-lg">
        ...
        <div>
          ...
          <input name="password" type="password" value={form.password} onChange={handleChange} className={inputClass} minLength={6} />
        </div>
        <div>
